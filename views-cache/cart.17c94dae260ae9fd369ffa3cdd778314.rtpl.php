                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                <input type="button" class="minus" name="minus" value="-" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/minus'">
                                                ...
                                                <input type="button" class="plus" name="add" value="+" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add'">
                                            </div>
                                        </td>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$<?php if( $cart["vlsubtotal"] == NULL ){ ?><?php echo formatPrice(0.00); ?><?php }else{ ?><?php echo formatPrice($cart["vlsubtotal"]); ?><?php } ?></span></td>
                                            </tr>
