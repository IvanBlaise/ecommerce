...
$app->get("/cart/:idproduct/add", function($idproduct)
{
	...
	for ($i=0; $i < $qtd ; $i++) { 
		...
		$cart->addProduct($product, (isset($_GET["name"])) ? "add" : "");
	}
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: ivan.carlos@gmail.com";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja Ivan E-commerce - www.ivancommerce.com.br";
...
$app->post("/profile/change-password", function(){
	...
	$user->setPassword(User::getpasswordHash($user->getdespassword()));
